    ...
    <div className="flex h-full flex-col">
      ...
      <div className="px-5 py-4 space-y-2">
        <p className="text-xs text-muted-foreground text-center">
          Made with <span className="text-primary">❤️</span> by Awwal
        </p>
        <div className="flex items-center justify-center gap-3">
          <a
            href="https://instagram.com/awwal_pituduh"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            href="https://www.linkedin.com/in/awwalpituduh/"
            target="_blank"
            rel="noreferrer"
            aria-label="LinkedIn"
            className="text-muted-foreground hover:text-primary transition-colors"
          ...
          <a
            href="https://github.com/eLsavation"
            target="_blank"
            rel="noreferrer"
            aria-label="GitHub"
            className="text-muted-foreground hover:text-primary transition-colors"
